const SITE = {
  title: 'Ziad Beranger / Editor, Director & Cinematographer, Sydney',
  description: 'Sydney-based editor, director and cinematographer with experience across broadcast television, independent film and branded content.'
};
